...
BEGIN
  ...
  WITH shots_data AS (
    ...
    FROM (VALUES
      ...
      ('10:18', 4,  'CB9', 3,  'miss',   NULL, NULL, FALSE, FALSE, NULL::integer),
      ('11:02', 13, 'RB6', 7,  'goal',   8,  2,    FALSE, TRUE,  NULL::integer),
      ('12:40', 2,  'LB6', 4,  'goal',   8,  NULL, FALSE, TRUE,  NULL::integer),
      ('13:30', 10, 'CB6', 5,  'block',  4,  NULL, FALSE, TRUE,  NULL::integer),
      ...
      ('21:48', 9,  'RB9', 10, 'miss',   8,  NULL, FALSE, FALSE, NULL::integer),
      ('23:04', 1,  'LW',  7,  'goal',   8,  NULL, TRUE,  FALSE, NULL::integer),
      ('24:36', 8,  'CB9', 5,  'goal',   2,  NULL, FALSE, FALSE, NULL::integer),
      ('25:20', 12, 'LB9', 11, 'miss',   8,  NULL, FALSE, FALSE, NULL::integer),
      ...
      ('39:14', 9,  'RB6', 3,  'block',  8,  NULL, FALSE, TRUE,  NULL::integer),
      ('41:03', 17, 'CB9', 2,  'goal',   8,  NULL, FALSE, FALSE, NULL::integer),
      ('43:27', 18, 'CB6', 7,  'goal',   4,  NULL, FALSE, TRUE,  NULL::integer),
      ('45:41', 5,  'RB9', 1,  'gksave', 8,  NULL, FALSE, FALSE, NULL::integer),
      ('48:30', 15, 'RW',  9,  'goal',   8,  NULL, TRUE,  FALSE, NULL::integer),
      ('52:24', 19, 'RB9', 10, 'goal',   8,  NULL, FALSE, FALSE, NULL::integer),
