  ...
  <div>
    ...
    >
      ...
      <text
        ...
        font-size="35"
      >
        {{ getShootingAreaInfo(zone.key)["text"] }}
      </text>
      ...
      <text
        ...
        font-size="35"
      >
        {{ getShootingAreaInfo("7M")["text"] }}
      </text>
      <path
        v-else
        d="M447.825 180L454.011 167.756V167.656H446.831V165.455H456.739V167.706L450.56 180H447.825ZM459.173 165.455H462.397L466.716 175.994H466.886L471.204 165.455H474.429V180H471.9V170.007H471.765L467.745 179.957H465.856L461.836 169.986H461.701V180H459.173V165.455Z"
...
const zones = [
  // {key:"", path: "M447.825 180L454.011 167.756V167.656H446.831V165.455H456.739V167.706L450.56 180H447.825ZM459.173 165.455H462.397L466.716 175.994H466.886L471.204 165.455H474.429V180H471.9V170.007H471.765L467.745 179.957H465.856L461.836 169.986H461.701V180H459.173V165.455Z" },
  {
    ...
    textX: 35,
    textY: 95,
    path: "M2.50781 139.5V7.5L22.4283 33.7112C40.5062 57.4979 64.4361 76.1974 91.8876 87.9886L128 103.5L61.5 123L2.50781 139.5Z"
  },
  {
    key: "RW",
    textX: 885,
    textY: 90,
    path: "M924.5 131C923.719 82.3797 924.499 6.5 924.499 6.5L893.986 38.9866C883.381 50.2777 871.307 60.0933 858.089 68.1702L814.998 94.5L868.498 113.5L924.5 131Z"
  },
  {
    key: "LB9",
    textX: 120,
    textY: 270,
    path: "M2.50781 143V317.5H311.008V231.5H210.467C158.979 231.5 109.955 209.45 75.7927 170.927L39.5 130L2.50781 143Z"
  },
  {
    key: "RB9",
    textX: 810,
    textY: 270,
    path: "M924.508 132V317.5H616.008V231.5L670 230.5L692.71 229.106C715.365 227.714 737.554 222.051 758.105 212.413L772.496 205.664C790.335 197.298 806.415 185.608 819.876 171.219L872 115.5L924.508 132Z"
  },
  {
    key: "LB6",
    textX: 200,
    textY: 170,
    path: "M43.5 131L80.4584 171.073C113.704 207.12 160.218 228.043 209.247 229.005L311 231V115L234 112L131.5 105L43.5 131Z"
  },
  {
    key: "RB6",
    textX: 710,
    textY: 170,
    path: "M814.5 95L870 114.5L831.5 157.5L817.972 171.028C790.404 198.596 754.632 216.467 716.034 221.956L666.5 229L617 230V115L739.99 110.27C753.289 109.758 766.49 107.773 779.352 104.351L814.5 95Z"
  },
  {
    key: "CB6",
    textX: 460,
    textY: 138,
    path: "M311 115V231H619V115L437.205 115H311Z"
  },
  {
    key: "CB9",
    textX: 460,
    textY: 275,
    path: "M310.5 231.5V317.5H618V231.5H436.5H310.5Z"
  }
...
function getShootingAreaInfo(target: ShootingArea) {
  if (props.statsMode) {
    if (props.player) {
      const shots = props.player.currentShots
        ?.filter(s => s.from === target)
        .filter(s =>
          props.selectedShootingTarget
            ? s.to === props.selectedShootingTarget
            : true
        );
      ...
      const shots = store.matches.match.value?.data.value?.shots
        .filter(
          s =>
            s.from === target && s.result !== "gkmiss" && s.result !== "gksave"
        )
        .filter(s =>
          props.selectedShootingTarget
            ? s.to === props.selectedShootingTarget
