...
import type { ShootingArea, ShootingResult, ShootingTarget, Stats, Player } from '~/types/handball';
...
export const useShotBuilder = () => {
    const shootingTarget = useState<ShootingTarget | null>('shotBuilder-target', () => null);
    const shootingArea = useState<ShootingArea | null>('shotBuilder-area', () => null);
